...
{
    class DiscordShoutBan : AbstractParameterizedCommand<IAdminCommand>
    {
        public override string VALUE => "DISCORDBAN";
        ...
        public override void Action(PlayerObject player, string[] vals)
        {
            ...
            character.Account.DiscordShoutExpiry = SEnvir.Now.AddMinutes(count);
        }
    }
}
